...
// //
// //       // Apply same filters as the Flutter app
...
// //
// // // ---------------------------------------------------------------------------
// // // Main scheduled function — runs daily at 7:15 PM NPT (13:30 UTC)
// // // NPT is UTC+5:45, so 7:15 PM NPT = 13:30 UTC
// // // ---------------------------------------------------------------------------
// // export const deactivateResignedStaff = onSchedule(
// //   {
// //     schedule: "30 13 * * *", // every day at 13:30 UTC = 7:15 PM NPT
// //     timeZone: "UTC",
// //     maxInstances: 1,
// //   },
// //   async () => {
...
// //
// //     // 1. Get all active phones from API
// //     const activePhones = await fetchAllActivePhones();
// //
// //     // 2. Get all active staff from Firestore
...
// //     }
// //
// //     // 3. Find resigned staff (in Firestore but not in API)
...
// //
// //       // Skip if no phone (manually registered staff without phone)
// //       if (!phone) continue;
// //
...
//       from: '"PassPoint System" <meet@pmlil.com>',
//       to: email.trim(),
